...
TARGETS = [
    ...
    },
    {
        ...
        "context": "NAIDOC gallery is captured as a collection-level visual source for Indigenous poster history; individual posters need later item-level review. Its ongoing range is source scope, not an object date.",
        "prefer_img": True,
    },
    {
        "direction_id": "NXS05",
        ...
        "context": "AIATSIS collection page is used as an authority/context record for NAIDOC poster history. Its ongoing range is source scope, not an object date.",
        "prefer_img": True,
    },
    {
        "direction_id": "NXS06",
