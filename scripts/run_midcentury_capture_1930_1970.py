...
def region_for(row: dict[str, str]) -> tuple[str, str, dict[str, list[str]]]:
    ...
    place_tests = [
        ...
        ("Cuba / transnational", "cuba", {"regionIds": ["REG004"], "geoIds": ["GEO029"]}),
        ("Colombia", "colombia", {"regionIds": ["REG004"], "geoIds": ["GEO033"]}),
        ("Peru", "peru", {"regionIds": ["REG004"], "geoIds": ["GEO033"]}),
        ("Bolivia", "bolivia", {"regionIds": ["REG004"], "geoIds": ["GEO033"]}),
        ("Venezuela", "venezuela", {"regionIds": ["REG004"], "geoIds": ["GEO033"]}),
        ("Chile", "chile", {"regionIds": ["REG004"], "geoIds": ["GEO032"]}),
        ("Egypt", "egypt", {"regionIds": ["REG013"], "geoIds": ["GEO056"]}),
        ("Iran", "iran", {"regionIds": ["REG013"], "geoIds": ["GEO083"]}),
        ("Iraq", "iraq", {"regionIds": ["REG013"], "geoIds": ["GEO059"]}),
        ("Lebanon", "lebanon", {"regionIds": ["REG013"], "geoIds": ["GEO059"]}),
        ("Palestine / transnational", "palestine", {"regionIds": ["REG013"], "geoIds": ["GEO084"]}),
        ("Morocco", "morocco", {"regionIds": ["REG013"], "geoIds": ["GEO060"]}),
        ("Algeria", "algeria", {"regionIds": ["REG013"], "geoIds": ["GEO060"]}),
        ("Turkey", "turkey", {"regionIds": ["REG013"], "geoIds": ["GEO058"]}),
        ("South Africa", "south africa", {"regionIds": ["REG014"], "geoIds": ["GEO062"]}),
        ("Nigeria", "nigeria", {"regionIds": ["REG014"], "geoIds": ["GEO063"]}),
        ("Ghana", "ghana", {"regionIds": ["REG014"], "geoIds": ["GEO064"]}),
        ("Kenya", "kenya", {"regionIds": ["REG014"], "geoIds": ["GEO065"]}),
        ("Ethiopia", "ethiopia", {"regionIds": ["REG014"], "geoIds": ["GEO099"]}),
        ("Tanzania", "tanzania", {"regionIds": ["REG014"], "geoIds": ["GEO065"]}),
        ("Senegal", "senegal", {"regionIds": ["REG014"], "geoIds": ["GEO100"]}),
        ("India", "india", {"regionIds": ["REG012"], "geoIds": ["GEO051"]}),
        ("Pakistan", "pakistan", {"regionIds": ["REG012"], "geoIds": ["GEO052"]}),
        ("Bangladesh", "bangladesh", {"regionIds": ["REG012"], "geoIds": ["GEO053"]}),
        ("Sri Lanka", "sri lanka", {"regionIds": ["REG012"], "geoIds": ["GEO054"]}),
        ("Nepal", "nepal", {"regionIds": ["REG012"], "geoIds": ["GEO092"]}),
        ("Indonesia", "indonesia", {"regionIds": ["REG011"], "geoIds": ["GEO044"]}),
        ("Malaysia", "malaysia", {"regionIds": ["REG011"], "geoIds": ["GEO045"]}),
        ("Singapore", "singapore", {"regionIds": ["REG011"], "geoIds": ["GEO095"]}),
        ("Thailand", "thailand", {"regionIds": ["REG011"], "geoIds": ["GEO046"]}),
        ("Vietnam", "vietnam", {"regionIds": ["REG011"], "geoIds": ["GEO047"]}),
        ("Philippines", "philippines", {"regionIds": ["REG011"], "geoIds": ["GEO048"]}),
        ("China / Hong Kong", "china", {"regionIds": ["REG008"], "geoIds": ["GEO040"]}),
        ("Taiwan", "taiwan", {"regionIds": ["REG010"], "geoIds": ["GEO042"]}),
        ("South Korea", "south korea", {"regionIds": ["REG006"], "geoIds": ["GEO038"]}),
        ("Korean Peninsula", "korea", {"regionIds": ["REG006"], "geoIds": ["GEO037"]}),
        ("Japan", "japan", {"regionIds": ["REG005", "REG007"], "geoIds": ["GEO036"]}),
        ("Ukraine", "ukraine", {"regionIds": ["REG002"], "geoIds": ["GEO017"]}),
        ("Poland", "poland", {"regionIds": ["REG002"], "geoIds": ["GEO018"]}),
        ("Romania", "romania", {"regionIds": ["REG002"], "geoIds": ["GEO021"]}),
        ("Bulgaria", "bulgaria", {"regionIds": ["REG002"], "geoIds": ["GEO022"]}),
        ("Georgia", "georgia", {"regionIds": ["REG002"], "geoIds": ["GEO080"]}),
        ("Armenia", "armenia", {"regionIds": ["REG002"], "geoIds": ["GEO079"]}),
        ("Azerbaijan", "azerbaijan", {"regionIds": ["REG002"], "geoIds": ["GEO081"]}),
        ("Kazakhstan", "kazakhstan", {"regionIds": ["REG002"], "geoIds": ["GEO073"]}),
        ("Uzbekistan", "uzbekistan", {"regionIds": ["REG002"], "geoIds": ["GEO074"]}),
        ("Kyrgyzstan", "kyrgyzstan", {"regionIds": ["REG002"], "geoIds": ["GEO075"]}),
        ("Tajikistan", "tajikistan", {"regionIds": ["REG002"], "geoIds": ["GEO076"]}),
        ("Turkmenistan", "turkmenistan", {"regionIds": ["REG002"], "geoIds": ["GEO077"]}),
        ("Australia / Indigenous", "australia", {"regionIds": ["REG015"], "geoIds": ["GEO069"]}),
        ("Aotearoa New Zealand", "new zealand", {"regionIds": ["REG015"], "geoIds": ["GEO070"]}),
