...
Auckland CONTENTdm records can carry images and rights fields. NDL SRU records are bibliographic and therefore IMG04 until a rights-visible digital object is verified. WordPress archive posts are promoted only as limited source-context records, not as object substitutes.
