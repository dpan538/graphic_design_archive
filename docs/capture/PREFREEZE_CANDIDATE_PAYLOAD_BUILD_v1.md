...
- skipped_by_p0_exclusion: 3549 (Rows blocked by pre-freeze cleaning gate.)
- rows_after_exclusion: 16337 (Rows eligible for global dedupe.)
- deduped_candidate_rows: 16294 (Rows passed to payload builder.)
- dedupe_removed_rows: 43 (Duplicate rows removed before surface build.)
- candidate_surfaces: 16180 (Surfaces generated in candidate payload.)
- candidate_active_public_sources: 14997 (Distinct source names in candidate payload.)
- candidate_research_dossiers: 16180 (Generated research dossier anchors.)
...
- candidate_image_state:IMG02: 574 (Candidate surface image state distribution.)
