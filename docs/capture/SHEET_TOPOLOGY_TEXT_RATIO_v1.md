...
- public_surfaces: 8636 (All generated public surfaces.)
- main_sheets: 8379 (publicationRole=main_sheet.)
- sub_or_support_surfaces: 257 (All surfaces not marked as main_sheet.)
- independent_text_sheet_surfaces: 242 (templateId=sheet.text.v0.)
- independent_text_sheet_surface_rate: 2.80 (Independent text-sheet surfaces / all surfaces.)
- sub_or_support_surface_rate: 2.98 (Non-main surfaces / all surfaces.)
- research_dossiers: 8636 (Generated dossier packets.)
- single_anchor_dossiers: 8369 (Dossiers still built around one source anchor.)
- compound_or_group_dossiers: 267 (Dossiers with grouped children or non-single source scope.)
- dossiers_with_any_text_page: 8622 (Dossier pageSequence contains at least one text_page.)
- dossiers_with_two_or_more_text_pages: 0 (Closer to the desired main-sheet package shape.)
- dossiers_with_more_than_two_pages: 2194 (Dossiers with meaningful packet depth beyond main + one text page.)
- average_dossier_pages: 2.27 (Mean pages per research dossier.)
