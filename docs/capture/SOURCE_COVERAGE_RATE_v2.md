...
- source_pool_period_fill_rate: 51.45 (Former v1 source_coverage_rate; capacity/time fill only, capped at 100%.)
- strict_distribution_adjusted_source_coverage_rate: 15.62 (v1 strict diagnostic retained as a first-class warning signal.)
...
- research_quality_adjusted_source_coverage_rate_v2: 1.44 (source_pool_period_fill * period_quality_main_balance * region_quality_main_balance * source_visible_rate.)
