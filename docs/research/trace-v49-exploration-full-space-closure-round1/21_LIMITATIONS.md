...
- Main remains un-fast-forwarded at report generation unless a later sealed receipt records otherwise: `MAIN_FAST_FORWARD_COMPLETED=false`.

Formal gate failures at report time: `0`. If non-zero, consult `22_FUNCTION3_CLOSURE_DECISION.md`; limitations never convert a failed closure gate into a pass.
