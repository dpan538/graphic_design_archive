...
All 21 Round 14 qualified associations occur in one or more real category compositions. All 14 failed cases remain audit-only. Direct and skip-one checks are made against frozen Round 14 qualification; failed and hard-negative associations cannot enter a map edge or tree.
