...
- Architecture: `ARCHITECTURE.md`, `DATA_MODEL_V49.md`, `docs/architecture/`
- Database migration: `MIGRATION_V48_TO_V49.md`, `database/data-migrations/v48-to-v49/README.md`
...
- Release index: `docs/releases/v49/RELEASE_INDEX.md`
...
- Archive policy: `docs/maintenance/RELEASE_AND_ARCHIVE_POLICY.md`
