...
- `api/` — current v49 Read API catalog, OpenAPI 3.1 contract, interface map, and examples.
- `architecture/` — architecture decisions and the v49 DDL decision record.
- `operations/` — current replay, verification, and environment boundary.
