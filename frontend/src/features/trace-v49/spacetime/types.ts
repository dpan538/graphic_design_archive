...
export type TracePlaceRole = "creation" | "publication" | "subject" | "collection" | "broad_region" | "unspecified";
export type TracePlacePrecision = "exact" | "city" | "country" | "region" | "broad_region" | "approximate" | "unknown";
export type TraceTimeRole = "creation" | "publication" | "subject" | "collection" | "unspecified";
